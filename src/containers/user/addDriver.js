...
import {
    dispatchRefreshDriver,
    dispatchRefreshDriverInfo,
    dispatchGetDriverInfo,
    dispatchClearDriverInfo
} from '../../action/driver';
    ...
    render() {
        ...
        if (this.state.addDriverLicenseSource) {
            enlargeImg = (
                <TouchableOpacity style={styles.touchStyle}
                                  onPress={() => {
                                      this.setState({showPhoto: true, activeIndex: 1})
                                  }}>
        ...
        return (
            <View style={styles.container}>
                ...
                <ImagePreview show={this.state.showPhoto} activeIndex={this.state.activeIndex} imagePathes={imagePathes}
                              hide={() => {
