                        ...
                        <View style={styles.title}>
                            ...
                            <View style={styles.rightContainer}>
                                ...
                                <View style={{flexDirection: 'row', flexWrap: 'wrap',}}>
                                    ...
                                    <CommonLabelCell content={`卸货点${distributionPoint}`} containerStyle={{backgroundColor: StaticColor.GREEN_POINTER_COLOR}} textStyle={{color: StaticColor.GREEN_POINTER_TEXT_COLOR}}/>
                                    {
                                        temperature ?
                                            <CommonLabelCell
