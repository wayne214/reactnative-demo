...
const HOST_TEST = 'http://carrier-mproxy-test.xianyiscm.com/';

const HOST_BEAT = 'http://carrier-mproxy-beta.xianyiscm.com/';

export const HOST = DEBUG ? HOST_TEST : 'http://app-api.lenglianmajia.com/';
