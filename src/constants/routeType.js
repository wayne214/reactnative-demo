...
// 回单成功
export const ROUTE_RECEIPT_SUCCESS_PAGE = 'ROUTE_RECEIPT_SUCCESS_PAGE';
// 回单
export const ROUTE_UPLOAD_RECEIPT_PAGE = 'ROUTE_UPLOAD_RECEIPT_PAGE';
// 批量回单
export const ROUTE_BATCH_UPLOAD_RECEIPT_PAGE = 'ROUTE_BATCH_UPLOAD_RECEIPT_PAGE';
// 百度地图
...
export const ROUTE_CAROWNER_CREAT_DRIVER = 'ROUTE_CAROWNER_CREAT_DRIVER';

export const ROUTE_SHOW_ZOOM_IMAGE = 'ROUTE_SHOW_ZOOM_IMAGE';
export const ROUTE_MESSAGE_DETAIL_MAIN = 'ROUTE_MESSAGE_DETAIL_MAIN';

// 运输在途信息监控详情
export const ROUTE_CAR_TRANSPORT_INFO = 'ROUTE_CAR_TRANSPORT_INFO';
// 更改手机号码
export const ROUTE_CHANGE_PHONE_NO = 'ROUTE_CHANGE_PHONE_NO';
export const ROUTE_CHANGE_PHONE_NO_STEP_ONE = 'ROUTE_CHANGE_PHONE_NO_STEP_ONE';
export const ROUTE_CHANGE_PHONE_NO_STEP_TWO = 'ROUTE_CHANGE_PHONE_NO_STEP_TWO';

// 历史订单查询
export const ROUTE_HISTORY_ORDER = 'ROUTE_HISTORY_ORDER';
